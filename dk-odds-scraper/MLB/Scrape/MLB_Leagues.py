"""
MLB Leagues Data Collection Script
...
urls = [
    # ("Winner", "YOUR_API_ENDPOINT_HERE"),
    # ("To_reach_LCS", "YOUR_API_ENDPOINT_HERE"),
    # ("Specials", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "data/Leagues"  # Configurable output directory
