...
urls = [
    ("MVP", "YOUR_API_ENDPOINT_HERE"),
    ("MVP_Player_VS_Field", "YOUR_API_ENDPOINT_HERE"),
    ("Cy_Young", "YOUR_API_ENDPOINT_HERE"),
    ("Rookie_of_year", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/Awards"
