...
urls = [
    ("Total_Runs", "YOUR_API_ENDPOINT_HERE"),
    ("Total_Runs_Alt", "YOUR_API_ENDPOINT_HERE"),
    ("HR", "YOUR_API_ENDPOINT_HERE"),
    ("Total_Bases", "YOUR_API_ENDPOINT_HERE"),
    ("SO", "YOUR_API_ENDPOINT_HERE"),
    ("Walks", "YOUR_API_ENDPOINT_HERE"),
    ("Singles", "YOUR_API_ENDPOINT_HERE"),
    ("Doubles", "YOUR_API_ENDPOINT_HERE"),
    ("Triples", "YOUR_API_ENDPOINT_HERE"),
    ("Extra_base_hits", "YOUR_API_ENDPOINT_HERE"),
    ("Double_plays", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/Team_Totals"
