...
urls = [
    ("Make_Playoffs", "YOUR_API_ENDPOINT_HERE"),
    ("Make_Playoffs_Y_N", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/Playoffs"
