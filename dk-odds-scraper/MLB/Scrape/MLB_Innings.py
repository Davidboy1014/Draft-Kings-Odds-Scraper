"""
MLB Innings Data Collection Script
...
urls = [
    # ("Inning_Runs", "YOUR_API_ENDPOINT_HERE"),
    # ("Inning_Result", "YOUR_API_ENDPOINT_HERE"),
    # ("Inning_Run_Line", "YOUR_API_ENDPOINT_HERE"),
    # ("Inning_Props", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "data/Inning"  # Configurable output directory
