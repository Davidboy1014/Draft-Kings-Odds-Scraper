...
urls = [
    ("Runs", "YOUR_API_ENDPOINT_HERE"),
    ("Hits", "YOUR_API_ENDPOINT_HERE"),
    ("Scoring", "YOUR_API_ENDPOINT_HERE"),
    ("SO", "YOUR_API_ENDPOINT_HERE"),
    ("Walks", "YOUR_API_ENDPOINT_HERE"),
    ("Pitches_thrown", "YOUR_API_ENDPOINT_HERE"),
    ("Batters_to_plate", "YOUR_API_ENDPOINT_HERE"),
    ("Result", "YOUR_API_ENDPOINT_HERE"),
    ("Run_Line", "YOUR_API_ENDPOINT_HERE"),
    ("Odd_Even", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/1st_Inning"
