"""
MLB 1st of Game Props Data Collection Script
...
urls = [
    # ("1st_Run_Team", "YOUR_API_ENDPOINT_HERE"),
    # ("1st_HR_Type", "YOUR_API_ENDPOINT_HERE"),
    # ("1st_SO_Thrown", "YOUR_API_ENDPOINT_HERE"),
    # ("1st_ER_Allowed", "YOUR_API_ENDPOINT_HERE"),
    # ("1st_Scoring_Play", "YOUR_API_ENDPOINT_HERE"),
...
output_dir = "data/1st_of_Game"  # Configurable output directory
