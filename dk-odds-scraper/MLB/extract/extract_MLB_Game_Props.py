...
# Config
folder_path = 'D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/Game_Props'
output_file = 'D:/School/Ai sports odds better/dk-odds-scraper/MLB/Excel_Files/MLB_Game_Props.xlsx'
...
def extract_game_props(data, sheet_name):
    ...
    for filename in os.listdir(folder_path):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            try:
                ...
                df = extract_game_props(data, sheet_name)
                df.to_excel(writer, sheet_name=sheet_name, index=False)
                print(f"✅ Wrote: {sheet_name}")
            except Exception as e:
                print(f"❌ Error in {filename}: {e}")

print(f"\n✅ All game props saved to {output_file}")
