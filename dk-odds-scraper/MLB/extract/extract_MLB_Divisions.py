...
# Config
folder_path = 'D:/School/Ai sports odds better/dk-odds-scraper/MLB/data/Divisions'
output_file = 'D:/School/Ai sports odds better/dk-odds-scraper/MLB/Excel_Files/MLB_Division.xlsx'

def extract_division_props(data, sheet_name):
    ...
    for selection in selections:
        ...
        division = event.get("name", "Unknown Division")
    ...
    for filename in os.listdir(folder_path):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            try:
                ...
                df = extract_division_props(data, sheet_name)
                df.to_excel(writer, sheet_name=sheet_name, index=False)
                print(f"✅ Wrote: {sheet_name}")
            except Exception as e:
                print(f"❌ Error processing {filename}: {e}")

print(f"\n✅ All division props saved to {output_file}")
