...
mlb_url = "YOUR_API_ENDPOINT_HERE"
headers = {
    "accept": "*/*",
...
response = requests.get(mlb_url, headers=headers)

if response.status_code == 200:
    with open("NFL_api_response.json", "w", encoding="utf-8") as f:
        json.dump(response.json(), f, indent=2)
    print("✅ NFL data saved to NFL_api_response.json")
else:
